...
const InvoiceForm = () => {
  ...
  const initialFormData = isEdit
    ? getOneInvoice(params.id) || getDefaultFormData()
    : isCopy && params.id
    ? {
        ...(getOneInvoice(params.id) || getDefaultFormData()),
        id: generateRandomId(),
  ...
  //calculate total on initial render
  useEffect(() => {
  ...
  //handle adding/updating invoice
      ...
      <Row>
        <Col md={8} lg={9}>
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            ...
            <div className="fs-4 fw-bold mb-4">Invoice Info</div>
          ...
          {/* Invoice Products */}
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            <h4 className="fw-bold mb-3">Invoice Products</h4>
            <InvoiceItem
          ...
          {/* Notes */}
          <Card className="p-4 p-xl-5 my-3 my-xl-4">
            <Form.Label className="fw-bold fs-4 ">Notes:</Form.Label>
            <Form.Control
        ...
        <Col md={4} lg={3}>
          <div className="sticky-top pt-md-3 pt-xl-4">
            ...
            <div className="mt-4 p-md-4  justify-content-center ">
              <Col lg={12}>
